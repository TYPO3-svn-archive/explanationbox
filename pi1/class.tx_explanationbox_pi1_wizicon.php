...
class tx_explanationbox_pi1_wizicon {
	...
	function proc(array $wizardItems)	{
		...
		$wizardItems['plugins_tx_explanationbox_pi1'] = array(
			'icon'=>t3lib_extMgm::extRelPath('explanationbox').'pi1/ce_wiz.gif',
			'title'=>$LANG->getLLL('pi1_title',$LL),
			'description'=>$LANG->getLLL('pi1_plus_wiz_description',$LL),
			'params'=>'&defVals[tt_content][CType]=list&defVals[tt_content][list_type]=explanationbox_pi1'
		);
	...
	function includeLocalLang()	{
		$llFile = t3lib_extMgm::extPath('explanationbox').'locallang.xml';
